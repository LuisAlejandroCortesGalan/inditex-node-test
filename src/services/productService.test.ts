...
describe('ProductService', () => {
  ...
  beforeEach(() => {
    ...
    // Configurar el mock de ProductApiClient
    mockProductApiClient = new ProductApiClient() as jest.Mocked<ProductApiClient>;
    
    // Crear instancia de ProductService con el cliente mockeado
  ...
  describe('getSimilarProducts', () => {
    it('should return similar products successfully', async () => {
      ...
      // Mock para cada llamada getProductDetail
    ...
    it('should handle failed product detail requests gracefully', async () => {
      ...
      // Mock para cada llamada getProductDetail, la segunda falla
      mockProductApiClient.getProductDetail
        .mockResolvedValueOnce(mockProducts[0])
      ...
      // Debería contener solo los productos que se pudieron obtener
